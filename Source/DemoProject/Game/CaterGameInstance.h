...
class UCaterInGameMenuProxy;
class UCaterMainMenuProxy;
...
UCLASS()
class DEMOPROJECT_API UCaterGameInstance : public UGameInstance
{
public:
	GENERATED_BODY()
...
private:
	UPROPERTY()
	UCaterMainMenuProxy* MainMenuUI;
	
	UPROPERTY()
	UCaterInGameMenuProxy* InGameMenuUI;

public:
	//callable from blueprint to get MainMenuUI
	UFUNCTION(BlueprintCallable, Category = "UCaterGameInstance")
	UCaterMainMenuProxy* GetMainMenuUIProxy() const { return MainMenuUI; }

	UFUNCTION(BlueprintCallable, Category = "UCaterGameInstance")
	UCaterInGameMenuProxy* GetInGameMenuUIProxy() const { return InGameMenuUI; }
